...
public class DeepThought {
    ...
    public int answer_to_the_ultimate_question_of_life_the_universe_and_everything(){
        ...
        System.out.println("I need to think a while about that one, come back again in 10.00 million years...");
    ...
    private void calculate(){
        ...
        System.out.println("10.00 million years have now passed and I have a answer");
    }
