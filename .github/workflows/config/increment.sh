...
# Set the new version
current_version=$(cat .github/workflows/config/version.txt) # Replace with your desired versioning logic
...
sed -i "s/^[[:space:]]*version:[[:space:]]*[0-9]\+\.[0-9]\+\.[0-9]\+$/version: $new_version/" .github/workflows/config/version.txt
